...
ClaraAskMe('tu es né quand ...',function(result){
...
if(day.length<1){ClaraIASpeech("je n'ai pas compris");return false}
			console.log(mois);
...
if( ((mois==11)&&(day>=15)) || ((mois==12)&& (day<=12))) {var msg="un paon !"}
			...
			console.log(msg);
			ClaraIASpeech("Alors... dans l'ancienne astrologie Maya, vous aurez été "+msg);
}
}
  getpet (result)
return  
